...
### 1. 簡介
歡迎使用 EasyGames Andoird SDK，當前最新版本為4.8.9510（androidx）。
...
```gradle
EASYGAMES_SDK_VERSION=4.8.9510
```
#### 3.2 lib 選擇
...
dependencies {
    ...
    // api 'com.linecorp.linesdk:linesdk:5.9.0'
    // LINE begin
}
...
```
#### 3.4 其他
minSdkVersion = 24，targetSdkVersion = 31
